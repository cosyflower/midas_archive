...
class GlobalConfig:
    ...
    # At remote server?
    # modified for separating files into sunny and night
    train_root_dir = ['/data/sunghun/data_generation/expert/train/Night', '/data/sunghun/data_generation/expert/train/Sunny']
    validate_root_dir = '/data/sunghun/data_generation/expert/validation'
    ...
    for train_root_per_dir in train_root_dir:    
        for town in train_towns:    
            if os.path.isdir(os.path.join(train_root_per_dir, town+'_short')): # /train/{town}_short
                train_data.append(os.path.join(train_root_per_dir, town+'_short'))
            if os.path.isdir(os.path.join(train_root_per_dir, town+'_tiny')):
                train_data.append(os.path.join(train_root_per_dir, town+'_tiny'))
            if os.path.isdir(os.path.join(train_root_per_dir, town+'_long')):
                train_data.append(os.path.join(train_root_per_dir, town+'_long'))
    ...
    input_resolution = 256 #means resoultion is 256x256??
