...
class GPT(nn.Module):
    ...
    def __init__(self, n_embd, n_head, block_exp, n_layer,
        ...
        self.weather_mode = config.weather_mode
    ...
    def forward(self, image_tensor, lidar_tensor, velocity, weather_class):
        ...
        ####  이 부분을 계속해서 수정해야 하는 상황 
        #### weather_class -> 0 혹은 1인 상황

        #### image_tensor을 그대로 images로 반영해야 하고 
...
class Encoder(nn.Module):
    ...
    def forward(self, image_list, lidar_list, velocity, weather_class):
        ...
        # image_tensor (is source image?)
        # use image_tensor for weather_embedding token? 
...
class TransFuser(nn.Module):
    ...
    def forward(self, image_list, lidar_list, target_point, velocity, weather_class):
        ...
        Args:
            ...
            weather class - data['weather_id] for embedding 
        '''
        # image_list (source image list)
